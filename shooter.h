...
public:
    Shooter(double position_x, double position_y, double vx_=100,double health_=3, double height=30, double width=18, double head_radius=8, Color color_=COLOR(0, 255, 0))
    {
        // Shooter constructor
        color = color_;
